    ...
    <div>
          {orderexistance ? (
            orders.map((item) => {
              return (
                <Card
                  className="text-center w-75 mx-auto mt-5 mb-2"
                  key={item._id}
                >
                  <Card.Header className="bg-secondary fw-semibold text-light">
                    Orders
                  </Card.Header>
                  <Card.Body>
                  ...
                  <Card.Footer className="bg-secondary fw-semibold text-light">
                    Shipping Price:${item.shippingPrice} - Total Price:$
                    {item.totalPrice}
                  </Card.Footer>
                </Card>
              );
